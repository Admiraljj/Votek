...
if __name__=='__main__':
    ...
    if args.task_name in ['mnli','rte','sst5','mrpc','dbpedia_14','hellaswag','xsum','nq']:
        if args.task_name=='xsum':
            ...
            if 'gpt-j' in args.model_name:
                from transformers import GPTJForCausalLM
                inference_model = GPTJForCausalLM.from_pretrained(args.model_name,cache_dir=args.model_cache_dir)
            else:
                from transformers import GPT2LMHeadModel
                inference_model = GPT2LMHeadModel.from_pretrained(args.model_name,cache_dir=args.model_cache_dir)
